...
<p>Game clients connect to this server and the server handles matchmaking on a first-come-first-serve basis. Once clients are paired, this server relays data between the clients. Data must be then manually validated and replicated, since it will be in a custom format</p>
<p>How to use:</p>
<ul>
